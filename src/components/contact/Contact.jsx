...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_s82svyn', 'template_cvdj1oa', form.current, 'wVS8G05_JYKBC-AHZ')
     e.target.reset()
  };
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">
                rubinaldomingos@gmail.com
              </span>
              <a
                href="mailto:rubinaldomingos@gmail.com"
        ...
        <div className="contact_content">
          ...
          <form className="contact_form" ref={form} onSubmit={sendEmail}>
            ...
            <div className="contact_form-div contact_form-area">
              <label className="contact_form-tag">How can I help?</label>
              <textarea
                name="project"
                cols="30"
                rows="10"
